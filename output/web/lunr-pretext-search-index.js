...
{
  "id": "sec-complex-homology",
  "level": "1",
  "url": "sec-complex-homology.html",
  "type": "Section",
  "number": "1.1",
  "title": "Complexes and Homology",
  "body": "Complexes and Homology  Complexes and Exact Sequences  Homological algebra is a branch of abstract algebra that studies the homology of chain complexes.  Chain Complex   A chain complex of -modules , also referred to simply as a complex, is a sequence of -modules and -module homomorphisms such that for all . We refer to as the module in homological degree . The maps are the differentials of our complex. We may sometimes omit the differentials and simply refer to the complex or even ; we may also sometimes refer to as the differential of .     In some contexts, it is important to make a distinction between chain complexes and co-chain complexes, where the arrows go the opposite way: a co-chain complex would look like We will not need to make such a distinction, so we will call both of these complexes and most often follow the convention in the definition above.   Bounded   We will say a complex is bounded above if for all , and bounded below if for all . A bounded complex is one that is both bounded above and below. If a complex is bounded, we may sometimes simply write it as a finite complex, say      The condition that for all implies that .   Exact   The complex is exact at if . An exact sequence is a complex that is exact everywhere.     Remark 9.7. The sequence is exact if and only if is injective. Similarly, is exact if and only if is surjective. So     is a short exact sequence if and only if     is injective     is surjective     .    Requiring that be injective is the same as asking that , while is surjective if and only if coker When this is indeed a short exact sequence, we can identify with its image , and . Moreover, since is surjective, by the First Isomorphism Theorem we conclude that , so we might abuse notation and identify with .   Remark 9.8. The complex is exact if and only if is an isomorphism.  Remark 9.9. The complex is exact if and only if .  Example 9.10. Let be the canonical projection . The following is a short exact sequence:     We will most often be interested in complexes of -modules, where the abelian groups that show up are all modules over the same ring .   The cokernel of a homomorphism is the -module . Example 9.11. Let be a polynomial ring over the field . Then following is a short exact sequence:     The first map is multiplication by , and the second map is the canonical projection.  Here are some more examples of complexes.  Example 9.12. Let . The following complex is exact:     Indeed, the image and the kernel of multiplication by are both .  Example 9.13. Let . Consider the following complex:     The image of multiplication by is , while the the kernel of multiplication by is . For all ,      Homology  Historically, chain complexes first appeared in topology. To study a topological space, one constructs a particular chain complex that arises naturally from information from the space, and then calculates its homology, which ends up encoding important topological information in the form of a sequence of abelian groups.  Homology   The homology of the complex is the sequence of -modules The th homology of is . The submodules are called cycles, while the submodules are called boundaries.    The homology of a complex measures how far our complex is from being exact at each point. Again, we can talk about the cohomology of a cochain complex instead; we will for now not worry about the distinction.   Note that is exact at if and only if .     Let be the canonical projection map. Then   is a complex, since the image of multiplication by is , and that is certainly contained in . The homology of is         Notice that our complex is exact at 2 and 0 . The exactness at 2 says that the map is injective, while exactness at 0 says that is surjective.  Those last remarks were not a coincidence. We repeat Remark 1.11 but now in this more general context.   "
},
{
  "id": "def-chain-complex",
  "level": "2",
  "url": "sec-complex-homology.html#def-chain-complex",
  "type": "Definition",
  "number": "1.1",
  "title": "Chain Complex.",
...
},
{
  "id": "remark-58",
  "level": "2",
  "url": "sec-complex-homology.html#remark-58",
  "type": "Remark",
  "number": "1.2",
  "title": "",
  "body": " In some contexts, it is important to make a distinction between chain complexes and co-chain complexes, where the arrows go the opposite way: a co-chain complex would look like We will not need to make such a distinction, so we will call both of these complexes and most often follow the convention in the definition above.  "
},
{
  "id": "def-bounded-complex",
  "level": "2",
  "url": "sec-complex-homology.html#def-bounded-complex",
  "type": "Definition",
  "number": "1.3",
  "title": "Bounded.",
  "body": "Bounded   We will say a complex is bounded above if for all , and bounded below if for all . A bounded complex is one that is both bounded above and below. If a complex is bounded, we may sometimes simply write it as a finite complex, say    "
},
{
  "id": "remark-59",
  "level": "2",
  "url": "sec-complex-homology.html#remark-59",
  "type": "Remark",
  "number": "1.4",
  "title": "",
...
},
{
  "id": "def-exact",
  "level": "2",
  "url": "sec-complex-homology.html#def-exact",
  "type": "Definition",
  "number": "1.5",
  "title": "Exact.",
  "body": "Exact   The complex is exact at if . An exact sequence is a complex that is exact everywhere.   "
},
{
  "id": "remark-60",
  "level": "2",
  "url": "sec-complex-homology.html#remark-60",
  "type": "Remark",
  "number": "1.6",
  "title": "",
  "body": " Remark 9.7. The sequence is exact if and only if is injective. Similarly, is exact if and only if is surjective. So     is a short exact sequence if and only if     is injective     is surjective     .    Requiring that be injective is the same as asking that , while is surjective if and only if coker When this is indeed a short exact sequence, we can identify with its image , and . Moreover, since is surjective, by the First Isomorphism Theorem we conclude that , so we might abuse notation and identify with .  "
},
{
  "id": "def-homology",
  "level": "2",
  "url": "sec-complex-homology.html#def-homology",
  "type": "Definition",
  "number": "1.7",
  "title": "Homology.",
  "body": "Homology   The homology of the complex is the sequence of -modules The th homology of is . The submodules are called cycles, while the submodules are called boundaries.   "
},
{
  "id": "remark-61",
  "level": "2",
  "url": "sec-complex-homology.html#remark-61",
  "type": "Remark",
  "number": "1.8",
  "title": "",
...
},
{
  "id": "example-132",
  "level": "2",
  "url": "sec-complex-homology.html#example-132",
  "type": "Example",
  "number": "1.9",
  "title": "",
  "body": "  Let be the canonical projection map. Then   is a complex, since the image of multiplication by is , and that is certainly contained in . The homology of is        "
},
{
  "id": "sec-rings-ideals",
  "level": "1",
...
},
{
  "id": "p-948",
  "level": "2",
  "url": "sec-rings-ideals.html#p-948",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-970",
  "level": "2",
  "url": "sec-rings-ideals.html#p-970",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "example-135",
  "level": "2",
  "url": "sec-rings-ideals.html#example-135",
  "type": "Example",
  "number": "A.12",
...
},
{
  "id": "remark-62",
  "level": "2",
  "url": "sec-rings-ideals.html#remark-62",
  "type": "Remark",
  "number": "A.14",
  "title": "",
...
},
{
  "id": "example-138",
  "level": "2",
  "url": "sec-modules.html#example-138",
  "type": "Example",
  "number": "A.19",
  "title": "",
